        ...
        <>
            ...
            <Modal modalRef={replyRef}>
                <div className='p-5 flex flex-col gap-4'>
                    <span className="text-[.6rem] sm:text-[.75rem] w-full text-primary bg-primary/20 dark:bg-primary p-2 rounded-xs uppercase text-center">Reply Message {selectedMessage?.subject} </span>
