      ...
      <section className="relative py-20 px-5 bg-white overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 flex flex-col">
          <div className="sm:w-[80%] md:w-[65%] lg:w-[50%] bg-white/50 md:bg-transparent pt-6 pr-3 flex flex-col justify-center">
            ...
            <p className="text-thin text-sitetext/80 leading-loose py-2">We provide you with guides, instructors, materials and resources to propel you into becoming a {category} professional beyond the periphery while splitting the learning process easily consumable bits for a smooth and progressive understanding.</p>
